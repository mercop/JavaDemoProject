...
public class BufferedRandomAccessFile extends RandomAccessFile {
    ...
    static ResourceBundle res = ResourceBundle.getBundle("com.alibaba.middleware.race.sync.test.Res");
    ...
    public static void main(String[] args) throws IOException {
        ...
        brafReadFile = new BufferedRandomAccessFile("C:\\home\\admin\\sync_results\\78517gs8re\\Result.rs");
        readfilelen = brafReadFile.initfilelen;
        brafWriteFile = new BufferedRandomAccessFile("d:\\STKAITI.001", "rw", 20);
        ...
        java.io.FileInputStream fdin = new java.io.FileInputStream("C:\\home\\admin\\sync_results\\78517gs8re\\Result11111.rs");
        java.io.BufferedInputStream bis = new java.io.BufferedInputStream(fdin, 1024);
        java.io.DataInputStream dis = new java.io.DataInputStream(bis);

        java.io.FileOutputStream fdout = new java.io.FileOutputStream("d:\\STKAITI.002");
        ...
        RandomAccessFile inRandomAccessFile = new RandomAccessFile("C:\\home\\admin\\sync_results\\78517gs8re\\Result2.rs", "r");
        ...
        RandomAccessFile outRandomAccessFile = new RandomAccessFile("d:\\STKAITI.003", "rw");
        ...
        System.out.println("MappedBufferFile Copy & Write File: "
                + brafReadFile.filename
                + "    FileSize: "
                + Integer.toString(inMappedByteBuffer.capacity()>> 1024)
                + " (KB)    "
                + "Spend: "
                +(double)(System.currentTimeMillis()-start) / 1000
                + "(s)");
